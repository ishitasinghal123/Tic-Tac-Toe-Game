...
from minmax import get_best_move  # Your own game logic

app = Flask(__name__)

# Proper CORS configuration for Vercel frontend
CORS(app, origins=["https://tic-tac-toe-game-sepia-iota.vercel.app"], supports_credentials=True)

@app.route('/')
def home():
    return "Backend is live!"

@app.route('/computer_move', methods=['POST', 'OPTIONS'])
def computer_move():
    ...
    return jsonify({'move': [best // 3, best % 3]})
